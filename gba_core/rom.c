...
*/
    ...
    if( (debugging_enable & (BIT(2)|BIT(7))) == (BIT(2)|BIT(7)) )
    {
        ...
        //Handler for Undefined instruction, Abort(prefetch), Abort(data), Reserved
        //DACS = Debugging And Communication System
        if(header->device_type & 0x80) ConsolePrint("0x9FE2000/1MBIT DACS\n");
        else ConsolePrint("0x9FFC000/8MBIT DACS\n");
    }
