...
static u32 gba_palview_sprpal = 0;
...
void Win_GBAPalViewerUpdate(void)
{
    ...
    u32 palram_index = gba_palview_selectedindex + (gba_palview_sprpal * 256);
    u16 value = ((u16 *)Mem.pal_ram)[palram_index];
...
static void _win_gba_pal_viewer_render(void)
{
    ...
    GUI_Draw(&gba_palviewer_window_gui, buffer,
