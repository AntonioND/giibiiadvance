...
int Win_GBSprViewerCreate(void)
{
    ...
    GUI_SetButton(&gb_sprview_zoomed_spr_dumpbtn,268,208,FONT_12_WIDTH*13,FONT_12_HEIGHT+6,"Dump zoomed",
                  _win_gb_sprviewer_zoomed_dump_btn_callback);

    GUI_SetButton(&gb_sprview_allspr_dumpbtn,268,238,FONT_12_WIDTH*13,FONT_12_HEIGHT+6,"Dump all",
