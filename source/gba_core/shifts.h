...
static u32 cpu_shift_by_immed(u32 type, u32 value, u8 shift, u8 *carry)
{
    ...
    {
        case 0:
            return lsl_shift_by_immed(value, shift, carry);
        case 1:
            return lsr_shift_by_immed(value, shift, carry);
        case 2:
            return asr_shift_by_immed(value, shift, carry);
        case 3:
            return ror_shift_by_immed(value, shift, carry);
        default:
            return 0;
    }
    return 0;
...
static u32 asr_shift_by_immed_no_carry(u32 value, u8 shift)
{
    if (shift == 0) // asr #32
    {
        return (value & BIT(31)) ? 0xFFFFFFFF : 0;
    }
    else
    {
#ifdef ENABLE_ASM_X86
...
static u32 cpu_shift_by_immed_no_carry(u32 type, u32 value, u8 shift)
{
    ...
    {
        case 0:
            return lsl_shift_by_immed_no_carry(value, shift);
        case 1:
            return lsr_shift_by_immed_no_carry(value, shift);
        case 2:
            return asr_shift_by_immed_no_carry(value, shift);
        case 3:
            return ror_shift_by_immed_no_carry(value, shift);
        default:
            return 0;
    }
    return 0;
...
static u32 cpu_shift_by_reg(u32 type, u32 value, u8 shift, u8 *carry)
{
    ...
    {
        case 0:
            return lsl_shift_by_reg(value, shift, carry);
        case 1:
            return lsr_shift_by_reg(value, shift, carry);
        case 2:
            return asr_shift_by_reg(value, shift, carry);
        case 3:
            return ror_shift_by_reg(value, shift, carry);
        default:
            return 0;
    }
    return 0;
...
static u32 cpu_shift_by_reg_no_carry(u32 type, u32 value, u8 shift)
{
    ...
    {
        case 0:
            return lsl_shift_by_reg_no_carry(value, shift);
        case 1:
            return lsr_shift_by_reg_no_carry(value, shift);
        case 2:
            return asr_shift_by_reg_no_carry(value, shift);
        case 3:
            return ror_shift_by_reg_no_carry(value, shift);
        default:
            return 0;
    }
    return 0;
